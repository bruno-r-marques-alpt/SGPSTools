...
{
    /// <summary>
    /// Summary description for ADPTCDetail.
    /// </summary>
    public class ADPTCDetail : System.Web.UI.Page
    {
        ...
        private bool LoadUserData(Page psPage, string psLogonName, string host, string dn, string dominio, string company)
        {
            /*try
			{*/
            ...
            if (objTable.Rows.Count >= 1)
            {
                ...
                txtEmpresa.Text = company;//oColumns.GetValue(6).ToString();
