<%@ Page language="c#" Codebehind="SMSWarning.aspx.cs" AutoEventWireup="false" Inherits="SGPStools.SMSWarning" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="SMSWarning" method="post" runat="server">
			<table width="455" border="0" cellspacing="0" cellpadding="0" class="tablecanais">
				...
				<tr>
					<td align="middle">
						<INPUT type="button" class="button" value="Seguinte" style="WIDTH: 85px" onclick='JavaScript:document.location="SMSTemplate.aspx?warningFalse=1&amp;<%=Request.QueryString.ToString()%>"' size="20">
