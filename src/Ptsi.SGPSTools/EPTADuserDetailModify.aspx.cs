...
namespace PTIntranetSGPS.UserManagent
{
    ...
    /// </summary>
    public class EPTADuserDetailModify : System.Web.UI.Page
    {
        ...
        protected System.Web.UI.WebControls.LinkButton lnkButton;
        ...
        {
            RequiredFieldValidator1.Text = CreateErrorImage("/SGPSTools/img/icon_bug.gif", "Não introduziu a password", "11", "11");
            ...
            if (!this.IsPostBack)
            {
                if (LoadUserData(this.Page, logonName, host, dn, dominio, companyName))
                {
                    if (IsUser(logonName) == false)
                    {
                        ...
                        txtTelefone1.CssClass = "for_gen_dis";

                        txtTelefone2.Enabled = false;
                        txtTelefone2.CssClass = "for_gen_dis";

                        txtTelemovel.Enabled = false;
                        txtTelemovel.CssClass = "for_gen_dis";

                        txtObservacoes.Enabled = false;
                        txtObservacoes.CssClass = "for_gen_dis_dash";

                        txtCategoria.Enabled = false;
                        txtCategoria.CssClass = "for_gen_dis";

                        txtDepartamento.Enabled = false;
                        txtDepartamento.CssClass = "for_gen_dis";

                        txtFax.Enabled = false;
                        txtFax.CssClass = "for_gen_dis";

                        txtLocalTrabalho.Enabled = false;
                        txtLocalTrabalho.CssClass = "for_gen_dis";

                        txtMorada.Enabled = false;
                        txtMorada.CssClass = "for_gen_dis";

                        txtDataUltimaActualizacao.Enabled = false;
                        txtDataUltimaActualizacao.CssClass = "for_gen_dis";
                    ...
                    else
                    {
                        ...
                        txtTelefone1.CssClass = "for_gen";
                        txtTelefone2.CssClass = "for_gen";
                        txtTelemovel.CssClass = "for_gen";
                        txtObservacoes.CssClass = "for_gen";
                        txtCategoria.CssClass = "for_gen";
                        txtDepartamento.CssClass = "for_gen";
                        txtFax.CssClass = "for_gen";
                        txtLocalTrabalho.CssClass = "for_gen";
                        txtMorada.CssClass = "for_gen";
                        txtDataUltimaActualizacao.CssClass = "for_gen";
