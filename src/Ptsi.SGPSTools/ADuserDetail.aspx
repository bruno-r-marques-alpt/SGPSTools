					...
					<td valign="top" width="100%">
						<div id="Text2Copy">
							<table border="0" height="457">
								...
								<tr>
									<td width="113"><asp:Label id="Label18" runat="server" Width="56px" Height="22px" ForeColor="#032B5E">Domínio:</asp:Label>
									</td>
									<td colspan="3">
								...
								<tr>
									<td width="113"><asp:Label id="Label10" runat="server" Width="102px" Height="22px" ForeColor="#032B5E">Telemóvel:</asp:Label>
									</td>
								...
								<tr>
									<td width="113"><asp:Label id="Label17" runat="server" Width="102px" Height="22px" ForeColor="#032B5E">Observações:</asp:Label>
									</td>
									<td colspan="3">
								...
								<tr>
									<td width="113"><asp:Label id="Label19" runat="server" Width="120px" Height="22px" ForeColor="#032B5E">Data Última Act.:</asp:Label>
									</td>
									...
									<table width="100%" height="100%" border="0">
										<tr>
											<td width="90" align="left" valign="middle"><INPUT type="button" class="button" value="Copiar" style="WIDTH: 85px; HEIGHT: 24px" onclick="CopyData2Clipboard()"
													size="20"></td>
											<td align="left" valign="middle"><span class="texto"> Clique aqui para copiar estas informações.</span></td>
										</tr>
									</table>
								</td>
							</tr>
