...
// Type: WindowsApplication1.ptsgps_spsdev011.searchResponse
...
namespace WindowsApplication1.ptsgps_spsdev011
{
    ...
    {
        [XmlElement("searchResultReference", typeof(string[]))]
        [XmlElement("searchResultEntry", typeof(searchResultEntry))]
        public object[] Items;
