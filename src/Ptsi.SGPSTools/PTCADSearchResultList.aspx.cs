...
namespace SGPStools.Templates
{
    ...
    /// </summary>
    public class PTCADSearchResultList : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (environment.Equals("PROD"))
            {
                ...
                {
                    if (Request.QueryString["department"] != "" && Request.QueryString["department"].Length > 1)
                    {
                ...
                /*if ((Request.QueryString["Empresa"] != "" || Request.QueryString["Empresa"] != null) && Request.QueryString["empresa"].Length > 1) 
				{
					ADList1.searchAdField[indice].searchField = "dNSHostName";
					ADList1.searchAdField[indice].searchValue = Request.QueryString["Empresa"];
					indice++;
				}*/

                ADList1.DetailPageName = "ADPTCuserDetail.aspx";
                ADList1.creatTableData(5);
                //ADList1.creatTableData(4);
                ...
                ADList1.tableData[3].columHeader = "Telefone";
                ADList1.tableData[3].adField = "telephonenumber";
                ...
                ADList1.tableData[4].columHeader = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                ADList1.tableData[4].adField = "mobile";

                // FALTA PEDIR OS CAMPOS COM SO DOMINIOS!!!!!
                //ADList1.CorpptDomain = Request.QueryString["Empresa"];
                ...
                //ADList1.aHiddenFields = new string[] {"mobile"};
        ...
        {
            string strName, strDepartment, strEmail, strContact, strMobile;
